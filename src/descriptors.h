...
const PROGMEM char normal_descriptor_conf[] = { // i think, i think, that this is the name vusb wants it in
	0x00, 0x09, // bLength
...
const PROGMEM char erglacon_descriptor_conf[] = { // i think, i think, that this is the name vusb wants it in
	0x00, 0x09, // bLength
	0x00, 0x21, // bDescriptorType
	0x00, 0x00, 0x01, 0x11, // bcdHID
	0x00, 0x08, // bCountryCode france
